...
st.pyplot(theta, s_Earth, color='black', zorder=5)
st.pyplot(theta, s_planet, color='black', zorder=6)
st.pyplot(theta, planet_radius, color='orange',zorder=3)
plt.fill_between(theta, planet_radius, alpha=0.5, color='orange', label='Radius of Exoplanet', zorder=2)
st.pyplot(theta, Earth_radius, color='red',zorder=4)
